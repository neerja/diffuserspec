...
% Inputs:
% spectralPSF_3D = 3D array containing calibration matrix with axes: y,x,lambda
% backgroundFrame = 2D image containg the background (dark) image
% Outputs:
% spectralPSF_3D = processed 3D array containing calibration matrix with axes: y,x,lambda
